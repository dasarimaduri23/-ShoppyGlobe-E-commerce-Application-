...
function ProductDetails() {
    ...
    return (
        <section className="mt-10 min-[500px]:mt-20 min-[500px]:mt-28 px-5 flex flex-col min-[500px]:flex-row items-center min-[500px]:items-start gap-x-5">
            <figure>
            ...
            <section>
                ...
                <section className="mt-3">
                    {
                        product?.tags.map(tag => {
                            return <span key={Math.floor(Math.random() * 1000000)} className="mr-2 text-[12px] font-semibold bg-sky-500 text-white py-1 px-3 rounded-full">{tag.toUpperCase()}</span>
                        })
                    }
                </section>
                ...
                <button
                    ...
                    className={`${!addedToCart ? "cursor-pointer opacity-100" : "cursor-not-allowed opacity-60"} mt-7 font-semibold text-[16px] min-[500px]:text-lg bg-sky-500 text-white py-2 px-4 rounded-lg`}><FontAwesomeIcon icon={faCartShopping} />

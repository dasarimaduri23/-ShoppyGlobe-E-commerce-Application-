        ...
        <section className="mt-8">
            <form action="" onSubmit={filterData} className="flex justify-center items-center gap-x-3">
                <input
                    ...
                    className="w-full outline-none border-2 border-sky-500 ps-2 pe-4 py-2 text-[17px] min-[500px]:text-lg rounded-md"
                />
                <button type="submit">
                    <FontAwesomeIcon icon={faSearch} className="bg-sky-500 text-white py-[15px] px-4 rounded-md text-lg" />
                </button>
            </form>
        </section>
    )
